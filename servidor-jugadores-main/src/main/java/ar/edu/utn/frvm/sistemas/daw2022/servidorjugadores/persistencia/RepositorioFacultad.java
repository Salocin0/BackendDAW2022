...
public interface RepositorioFacultad extends PagingAndSortingRepository<Facultad, Integer> {
    Page<Facultad> findByNombreIgnoreCaseContainingAndCodigoIgnoreCaseContainingAndCodigoNumericoIgnoreCaseContaining(String nombre, String codigo, String codigoNumerico, Pageable pageable);
}
